  ...
  return (
    <>
      ...
      <main className="max-w-8xl mx-auto px-2 md:px-16 py-8">
        ...
        <div className="sticky top-[73px] z-40 bg-background-light/95  border-y border-border-gold dark:border-white/10 py-4 mb-10 flex flex-wrap px-4 items-center justify-between gap-4">
          <div className="flex items-center gap-6 font-sans text-sm">
            <span className="text-stone-500 uppercase tracking-widest font-bold">48 Results</span>
            <div className="flex items-center gap-2 border-l border-border-gold pl-6">
              <button className="size-8 flex items-center justify-center text-primary bg-primary/10 rounded">
                <span className="material-symbols-outlined">grid_view</span>
              </button>
              <button className="size-8 flex items-center justify-center text-stone-400 hover:text-stone-600">
                <span className="material-symbols-outlined">view_list</span>
              </button>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <button className="flex items-center gap-2 font-sans text-sm font-bold uppercase tracking-widest border border-border-gold px-4 py-2 rounded-lg hover:bg-stone-50 transition-colors">
              <span className="material-symbols-outlined text-xl">filter_list</span>
              Filter
            </button>
            <div className="relative group">
              <button className="flex items-center gap-2 font-sans text-sm font-bold uppercase tracking-widest bg-primary text-white px-6 py-2 rounded-lg shadow-lg shadow-primary/20">
                Sort by: Featured
