...
export function CuratedFavorites() {
  return (
    <section className="max-w-7xl mx-auto px-6 py-24">
      <div className="text-center mb-16">
        <h2 className="text-[36px] font-display font-bold mb-3">Curated Favorites</h2>
        <p className="font-sans text-[16px] text-[#666] tracking-wide">
